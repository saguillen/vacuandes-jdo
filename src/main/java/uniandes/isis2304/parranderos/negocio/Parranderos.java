...
public class Parranderos 
{
	...
	public Usuario adicionarUsuario (String nombre, long cedula, String correo, String contrasenia,String Tipo)
	{
	    log.info ("Adicionando Usuario [" + nombre + ", " + cedula + correo + contrasenia + Tipo +  "]");
	    Usuario resp = pp.adicionarUsuario (nombre, cedula, correo, contrasenia, Tipo);
	...
	{
		log.info ("Generando los VO de Usuario");        
        List<VOUsuario> voTipos = new LinkedList<VOUsuario> ();
	...
	{
		log.info ("Eliminando Usuario por cedula: " + cedula);
        long resp = pp.eliminarUsuarioPorCedula (cedula);		
        log.info ("Eliminando Usuario por cedula: " + resp + " tuplas eliminadas");
        return resp;
	}
	
	public Vacuna adicionarVacuna (String fabricante, long idlote)
	{
	    log.info ("Adicionando Vacuna [" + fabricante + "," + idlote+ "]");
	    Vacuna resp = pp.adicionarVacuna (fabricante, idlote);
	    log.info ("Adicionando Vacuna: " + resp + " tuplas insertadas");
	    return resp;
	}
	
	public List<VOVacuna> darVOVacunas ()
	{
		log.info ("Generando los VO de Vacuna");        
        List<VOVacuna> voTipos = new LinkedList<VOVacuna> ();
        for (Vacuna tb : pp.darVacunas())
        {
        	voTipos.add (tb);
        	System.out.println(tb.toString());
        }
        log.info ("Generando los VO de Vacuna: " + voTipos.size() + " existentes");
        return voTipos;
	}
	
	public long eliminarVacunaPorID (long idVacuna)
	{
		log.info ("Eliminando Vacuna por id: " + idVacuna);
        long resp = pp.eliminarVacunaPorId (idVacuna);		
        log.info ("Eliminando Vacuna por id: " + resp + " tuplas eliminadas");
        return resp;
	}
	
	public EPSRegional adicionarEPSRegional (long dosis, String fabricante, String nombre, long idadmin)
	{
	    log.info ("Adicionando Vacuna [" + dosis + "," + fabricante+ ","+nombre+","+idadmin+"]");
	    EPSRegional resp = pp.adicionarEPSRegional (dosis,fabricante,nombre,idadmin);
	    log.info ("Adicionando Vacuna: " + resp + " tuplas insertadas");
	    return resp;
	}
	
	public List<VOEPSRegional> darVOEPSRegional ()
	{
		log.info ("Generando los VO de EPS");        
        List<VOEPSRegional> voTipos = new LinkedList<VOEPSRegional> ();
        for (EPSRegional tb : pp.darEPSRegionales())
        {
        	voTipos.add (tb);
        	System.out.println(tb.toString());
        }
        log.info ("Generando los VO de EPS: " + voTipos.size() + " existentes");
        return voTipos;
	}
	
	public long eliminarEPSRegionalPorId (long idEPS)
	{
		log.info ("Eliminando EPSRegional por id: " + idEPS);
        long resp = pp.eliminarEPSRegionalPorId (idEPS);		
        log.info ("Eliminando EPSRegional por id: " + resp + " tuplas eliminadas");
        return resp;
	}
	
	
	public PuntoVacunacion adicionarPuntoVacunacion (long capacidad, String localizacion, String infraestructura, long idEps, long idAdmin, long idOperador)
	{
	    log.info ("Adicionando Punto [" + capacidad + "," + localizacion+ ","+infraestructura+","+idEps+","+idAdmin+","+idOperador+"]");
	    PuntoVacunacion resp = pp.adicionarPuntoVacunacion (capacidad,localizacion,infraestructura,idEps,idAdmin,idOperador);
	    log.info ("Adicionando Vacuna: " + resp + " tuplas insertadas");
	    return resp;
	}
	
	public List<VOPuntoVacunacion> darVOPuntoVacunacion()
	{
		log.info ("Generando los VO de Puntos");        
        List<VOPuntoVacunacion> voTipos = new LinkedList<VOPuntoVacunacion> ();
        for (PuntoVacunacion tb : pp.darPuntosVacunacion())
        {
        	voTipos.add (tb);
        	System.out.println(tb.toString());
        }
        log.info ("Generando los VO de Puntos: " + voTipos.size() + " existentes");
        return voTipos;
	}
	
	public long eliminarPuntoVacunacionPorId (long idPunto)
	{
		log.info ("Eliminando Punto por id: " + idPunto);
        long resp = pp.eliminarPuntoVacunacionPorId (idPunto);		
        log.info ("Eliminando punto por id: " + resp + " tuplas eliminadas");
        return resp;
	}
	...
	public List<VOVacunacion> darVOVacunacion()
	{
        ...
        log.info ("Generando los VO de Vacunaciones: " + voTipos.size() + " existentes");
        return voTipos;
	}
	
	public long eliminarVacunacionPorId (long idVac)
	{
		log.info ("Eliminando vacunacion por id: " + idVac);
        long resp = pp.eliminarVacunacionPorId (idVac);		
        log.info ("Eliminando vacunacion por id: " + resp + " tuplas eliminadas");
        return resp;
	}
	
	public Ciudadano adicionarCiudadano (long edad, String ocupacion, long enfermedad, String grupo, long etapa, String estado, long idUsuario, long idPuntoV)
	{
	...
	public List<VOCiudadano> darVOCiudadano()
	{
        ...
        List<VOCiudadano> voTipos = new LinkedList<VOCiudadano> ();
        for (Ciudadano tb : pp.darCiudadanos())
        {
        	voTipos.add (tb);
        	System.out.println(tb.toString());
        }
        log.info ("Generando los VO de ciudadano: " + voTipos.size() + " existentes");
        return voTipos;
	}
	
	public VOLoteVacuna adicionarLoteVacuna (long cantidad, long idEPS, long idPuntoV)
	{
	    log.info ("Adicionando Punto [" + cantidad + "," + idEPS+","+idPuntoV+"]");
	    LoteVacuna resp = pp.adicionarLoteVacuna (cantidad,idEPS,idPuntoV);
	    log.info ("Adicionando Punto: " + resp + " tuplas insertadas");
	    return resp;
	}
	
	public List<VOLoteVacuna> darVOLoteVacuna()
	{
		log.info ("Generando los VO de lotes");        
        List<VOLoteVacuna> voTipos = new LinkedList<VOLoteVacuna> ();

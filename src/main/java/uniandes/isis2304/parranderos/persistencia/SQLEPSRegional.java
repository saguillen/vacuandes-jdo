...
class SQLEPSRegional 
{
	 ...
	 */
	public SQLEPSRegional (PersistenciaParranderos pp)
	{
		this.pp = pp;
	}
	 ...
	 */
	public long adicionarEPSRegional (PersistenceManager pm, long idEPS, long dosis,String region, String nombre,long idadmin) 
	{
        Query q = pm.newQuery(SQL, "INSERT INTO " + pp.darTablaEPSRegional() + "(id, dosistotales, region, nombre,idadmin) values (?, ?, ?, ?, ?)");
        q.setParameters(idEPS, dosis, region, nombre, idadmin);
	 ...
	 * @return EL número de tuplas eliminadas
	 */
	public long eliminarEPSRegionalPorId (PersistenceManager pm, long idEPS)
	{

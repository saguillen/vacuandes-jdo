...
//        	e.printStackTrace();
	...
	public Usuario adicionarUsuario(String nombre, long cedula, String correo, String contrasenia, String tipo) 
	{
        ...
        try
        {
            ...
            long tuplasInsertadas = sqlUsuario.adicionarUsuario(pm, idUsuario, nombre, cedula, correo, contrasenia,tipo);
            tx.commit();

            log.trace ("Inserción de usuario: " + nombre + ": " + tuplasInsertadas + " tuplas insertadas");

            return new Usuario (idUsuario, nombre, cedula, correo, contrasenia,tipo);
        }
        catch (Exception e)
        {
//        	e.printStackTrace();
...
//        	e.printStackTrace();
	...
	public Vacuna adicionarVacuna(String fabricante, long idlote) 
	{
        ...
        try
        {
            ...
            long tuplasInsertadas = sqlVacuna.adicionarVacuna(pm, idVacuna, fabricante,idlote);
            tx.commit();

            log.trace ("Inserción de vacuna: " + fabricante + ": " + tuplasInsertadas + " tuplas insertadas");

            return new Vacuna(idVacuna,fabricante,idlote);
        }
        catch (Exception e)
        {
//        	e.printStackTrace();
	...
	public long eliminarVacunaPorId (long idVacuna) 
	{
        ...
        {
            tx.begin();
            long resp = sqlVacuna.eliminarVacunaPorId(pm, idVacuna);
            tx.commit();
            return resp;
        }
        catch (Exception e)
...
//        	e.printStackTrace();
	...
	public EPSRegional adicionarEPSRegional(long dosis, String region, String nombre, long idadmin) 
	{
		PersistenceManager pm = pmf.getPersistenceManager();
        Transaction tx=pm.currentTransaction();
        try
        {
            tx.begin();
            long idEps = nextval ();
            long tuplasInsertadas = sqlEPSRegional.adicionarEPSRegional(pm, idEps,dosis, region,nombre,idadmin);
            tx.commit();

            log.trace ("Inserción de eps: " + nombre + ": " + tuplasInsertadas + " tuplas insertadas");

            return new EPSRegional(idEps,dosis,region,nombre,idadmin);
        }
        catch (Exception e)
        {
//        	e.printStackTrace();
	...
	public List<EPSRegional> darEPSRegionales ()
	{
		return sqlEPSRegional.darEPSRegionales(pmf.getPersistenceManager());
	}
	...
	public long eliminarEPSRegionalPorId (long idEPS) 
	{
        ...
        {
            tx.begin();
            long resp = sqlEPSRegional.eliminarEPSRegionalPorId(pm, idEPS);
            tx.commit();
            return resp;
        }
        catch (Exception e)
...
//        	e.printStackTrace();
	...
	public PuntoVacunacion adicionarPuntoVacunacion(long capacidad, String localizacion, String infraestructura, long idEps2, long idAdmin, long idOperador) 
	{
		PersistenceManager pm = pmf.getPersistenceManager();
        Transaction tx=pm.currentTransaction();
        try
        {
            tx.begin();
            long idpunto = nextval ();
            long tuplasInsertadas = sqlPuntoVacunacion.adicionarPuntoVacunacion(pm,idpunto, capacidad,localizacion,infraestructura,idEps2,idAdmin,idOperador);
            tx.commit();

            log.trace ("Inserción de punto: " + localizacion + ": " + tuplasInsertadas + " tuplas insertadas");

            return new PuntoVacunacion(idpunto, capacidad, localizacion, infraestructura, idEps2, idAdmin, idOperador);
        }
        catch (Exception e)
        {
//        	e.printStackTrace();
	...
	public long eliminarPuntoVacunacionPorId (long idPunto) 
	{
        ...
        {
            tx.begin();
            long resp = sqlPuntoVacunacion.eliminarPuntoVacunacionPorId(pm, idPunto);
            tx.commit();
            return resp;
        }
        catch (Exception e)
...
//        	e.printStackTrace();
	...
	public Ciudadano adicionarCiudadano(long edad, String ocupacion, long enfermedad, String grupo, long etapa, String estado, long idUsuario2, long idPuntoV) 
	{
		PersistenceManager pm = pmf.getPersistenceManager();
        Transaction tx=pm.currentTransaction();
        try
        {
            tx.begin();
            long idCiud = nextval ();
            long tuplasInsertadas = sqlCiudadano.adicionarCiudadano(pm, idCiud,edad,ocupacion,enfermedad,grupo,etapa,estado,idUsuario2, idPuntoV);
            tx.commit();

            log.trace ("Inserción de ciudadano: " + idCiud + ": " + tuplasInsertadas + " tuplas insertadas");

            return new Ciudadano(idCiud, edad, ocupacion, enfermedad, grupo, etapa, estado, idUsuario2, idPuntoV);
        }
        catch (Exception e)
        {
//        	e.printStackTrace();
	...
	public LoteVacuna adicionarLoteVacuna(long cantidad, long idEPS, long idPuntoV) 
	{
		PersistenceManager pm = pmf.getPersistenceManager();
        Transaction tx=pm.currentTransaction();
        try
        {
            tx.begin();
            long idLote = nextval ();
            long tuplasInsertadas = sqlLoteVacuna.adicionarLoteVacuna(pm,idLote, cantidad, idEPS,idPuntoV);
            tx.commit();

            log.trace ("Inserción de ciudadano: " + idLote + ": " + tuplasInsertadas + " tuplas insertadas");

            return new LoteVacuna(idLote,cantidad,idEPS,idPuntoV);
        }
        catch (Exception e)
        {
//        	e.printStackTrace();

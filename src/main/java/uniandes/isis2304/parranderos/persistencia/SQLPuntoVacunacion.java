...
class SQLPuntoVacunacion 
{
	 ...
	 */
	public SQLPuntoVacunacion (PersistenciaParranderos pp)
	{
		this.pp = pp;
	}
	 ...
	 */
	public long adicionarPuntoVacunacion (PersistenceManager pm, long idPunto, long capacidad, String localizacion, String infraestructura, long idEps2, long idAdmin, long idOperador) 
	{
        Query q = pm.newQuery(SQL, "INSERT INTO " + pp.darTablaPuntoVacunacion() + "(id, capacidad, localizacion, infraestructura, ideps, idadmin, idoperador) values (?, ?, ?, ?, ?, ?, ?)");
        q.setParameters(idPunto, capacidad, localizacion, infraestructura, idEps2, idAdmin,idOperador);
	 ...
	 * @return EL número de tuplas eliminadas
	 */
	public long eliminarPuntoVacunacionPorId (PersistenceManager pm, long idBar)
	{

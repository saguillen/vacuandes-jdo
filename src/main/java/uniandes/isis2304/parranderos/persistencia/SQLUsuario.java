...
class SQLUsuario 
{
	 ...
	 */
	public long adicionarUsuario (PersistenceManager pm, long idUsuario, String nombre, long cedula, String correo, String contrasenia, String tipo) 
	{
        Query q = pm.newQuery(SQL, "INSERT INTO " + pp.darTablaUsuario () + "(id, nombre, cedula, correo, contrasenia, tipo) values (?, ?, ?, ?, ?, ?)");
        q.setParameters(idUsuario, nombre, cedula, correo, contrasenia, tipo);

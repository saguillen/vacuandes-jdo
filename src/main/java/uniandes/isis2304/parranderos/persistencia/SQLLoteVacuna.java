...
class SQLLoteVacuna
{
	 ...
	 */
	public SQLLoteVacuna (PersistenciaParranderos pp)
	{
		this.pp = pp;
	}
	 ...
	 */
	public long adicionarLoteVacuna(PersistenceManager pm, long idLote, long cantidad, long idEPS, long idPuntoV) 
	{
        Query q = pm.newQuery(SQL, "INSERT INTO " + pp.darTablaLoteVacuna() + "(id, cantidad, ideps, idpuntov) values (?, ?, ?, ?)");
        q.setParameters(idLote, cantidad,idEPS,idPuntoV);
	 ...
	 */
	public List<LoteVacuna> darLoteVacunas (PersistenceManager pm)
	{
